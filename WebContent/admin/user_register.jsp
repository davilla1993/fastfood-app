...
<head>
    ...
    <title>Pyramid Fastfood | Create new user</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Create a new user</h2>
                        ...
                        <form id="registerForm" method="post" action="create_user" class="register-form">
