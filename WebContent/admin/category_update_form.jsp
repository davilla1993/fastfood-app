...
<head>
    ...
    <title>Pyramid Fastfood | Update category</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form id="registerForm" method="post" action="update_category" class="register-form">
                        <input type="hidden" name="idcategory" value="${category.idcategory}">
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="name" id="name" value="${category.name}" placeholder="Category Name"/>
                            </div>
